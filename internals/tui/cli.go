...
const (
	...
	instruction = "q/esc: Quit | j/down: Next worktree | k/up: Previous worktree | ctrl+a: Add new worktree | \nctrl+d: Delete current worktree | ctrl+l: Lock current worktree | ctrl+u: Unlock current worktree"
